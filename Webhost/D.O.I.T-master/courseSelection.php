				...
				<div class="col">
					<div class="section_title_container text-center">
						...
						<div class="section_subtitle">
							<h3><strong>This page lists all courses. Selecting a course will list relating modules.</strong></h3><br>
