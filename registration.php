                    ...
                    <div class="input-group-addon mb-3 ">
                       ...
                       <div class="input-group-addon mb-3">
						 ...
						 <div class="input-group-addon mb-3">
                            ...
                            <input id="inpdate" type="date" name="dob" class="form-control ml-4 " required="required"  placeholder="dd/mm/yyyy">
                        </div>
						 <div class="input-group-addon mb-3">
                                <div class="input-group-prepend">
                                    <span class="custom-file ">Upload Image</span>
                                </div>
                                <input type="file" name="pic" class="form-control-file ml-3" id="imageID" placeholder="Choose file path">
                        </div>
                       <div class="input-group-addon mb-3">
                        <div class="input-group-prepend">
