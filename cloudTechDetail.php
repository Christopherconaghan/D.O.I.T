						...
						<div class="row courses_row">
							...
							<div class="col-lg-4 course_col">
								<div class="course">
									...
									<div class="course_body">
										<h3 class="course_title"><a href="courseSelection.php">Network Fundaentals (Sem 1)</a></h3>
							...
							<div class="col-lg-4 course_col">
								<div class="course">
									...
									<div class="course_body">
										<h3 class="course_title"><a href="courseSelection.php">Private Cloud (Sem 1)</a></h3>
										<div class="course_teacher">R. Lennon</div>
						...
						<div class="row courses_row">
							<div class="col-lg-6 course_col">
								<div class="course">
									...
									<div class="course_body">
										<h3 class="course_title"><a href="courseSelection.php">Network Services (Sem 2)</a></h3>
										<div class="course_teacher">R. Lennon</div>
							...
							<div class="col-lg-6 course_col">
								<div class="course">
									...
									<div class="course_body">
										<h3 class="course_title"><a href="courseSelection.php">API Programming (Sem 2)</a></h3>
										<div class="course_teacher">R. Lennon</div>
