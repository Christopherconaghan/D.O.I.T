							...
							<div class="col-lg-3 footer_col">
								...
								<div class="footer_section footer_contact">
									...
									<div class="footer_contact_info">
										<ul>
											<li>Email: info.admissions@DOiT.com</li>
											<li>Phone:  +(353) 91 123 4567</li>
											<li>Port Road, Letterkenny, Donegal, Ireland</li>
										</ul>
									</div>
								</div>
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | by <a href="https://lyit.ie" target="_blank">DOiT</a></div>
						<div class="ml-lg-auto cr_links">
							<ul class="cr_list">
								<!--<li><a href="admin/admin_login.php">Admin Access</a></li>-->
