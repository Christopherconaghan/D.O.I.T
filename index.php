<?php include "header.php";?>
	...
	<div class="courses">
		...
		<div class="container">
			...
			<div class="row">
				<div class="col">
					<div class="courses_button trans_200"><a href="courseselection.php">view all courses</a></div>
				</div>
			</div>
		</div>
	</div>
					...
					<div class="counter_content">
						...
						<div class="milestones d-flex flex-md-row flex-column align-items-center justify-content-between">
							...
							<div class="milestone">
								...
								<div class="milestone_text">lecturers</div>
							</div>

							<!-- Milestone -->
							<div class="milestone">
							<div class="milestone_counter" data-end-value="400" data-sign-after="+">0</div>
								<div class="milestone_text">daily lessons</div>
							</div>
